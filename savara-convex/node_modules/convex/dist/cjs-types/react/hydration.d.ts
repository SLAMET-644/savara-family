import { FunctionReturnType, FunctionReference, FunctionReference_future } from "../server/api.js";
/**
 ...
 * @public
 */
export declare function usePreloadedQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(preloadedQuery: Preloaded<Query>): FunctionReturnType<Query>;
