 ...
 * @public
 */
export declare function useQueries(queries: RequestForQueriesCompat): Record<string, any | undefined | Error>;
/**
 * Internal version of `useQueries` that is exported for testing.
 */
export declare function useQueriesHelper(queries: RequestForQueriesCompat, createWatch: CreateWatch): Record<string, any | undefined | Error>;
/**
...
type RequestForQueriesCompat = Record<string, {
