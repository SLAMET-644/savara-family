...
import { ArgsAndOptions, FunctionReturnType, OptionalRestArgs, ValidatorTypeToReturnType, FunctionReference, FunctionReference_future } from "../server/api.js";
...
export interface GenericMutationCtx<DataModel extends GenericDataModel> {
     ...
     * ```
     */
    runQuery: <Query extends FunctionReference<"query", "public" | "internal"> | FunctionReference_future<"query", "public" | "internal">>(query: Query, ...args: ArgsAndOptions<Query, AdvancedRunQueryOptions>) => Promise<FunctionReturnType<Query>>;
    /**
     ...
     */
    runMutation: <Mutation extends FunctionReference<"mutation", "public" | "internal"> | FunctionReference_future<"mutation", "public" | "internal">>(mutation: Mutation, ...args: ArgsAndOptions<Mutation, {
...
export interface GenericQueryCtx<DataModel extends GenericDataModel> {
     ...
     * and creating a new isolated JS context.
     */
    runQuery: <Query extends FunctionReference<"query", "public" | "internal"> | FunctionReference_future<"query", "public" | "internal">>(query: Query, ...args: ArgsAndOptions<Query, {
        transactionLimits?: TransactionLimits;
...
export interface GenericActionCtx<DataModel extends GenericDataModel> {
     ...
     */
    runQuery<Query extends FunctionReference<"query", "public" | "internal"> | FunctionReference_future<"query", "public" | "internal">>(query: Query, ...args: OptionalRestArgs<Query>): Promise<FunctionReturnType<Query>>;
    /**
     ...
     */
    runMutation<Mutation extends FunctionReference<"mutation", "public" | "internal"> | FunctionReference_future<"mutation", "public" | "internal">>(mutation: Mutation, ...args: OptionalRestArgs<Mutation>): Promise<FunctionReturnType<Mutation>>;
    /**
     ...
     */
    runAction<Action extends FunctionReference<"action", "public" | "internal"> | FunctionReference_future<"action", "public" | "internal">>(action: Action, ...args: OptionalRestArgs<Action>): Promise<FunctionReturnType<Action>>;
    /**
     * A utility for scheduling Convex functions to run in the future.
     */
    scheduler: Scheduler;
