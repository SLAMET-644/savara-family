...
export declare function setupActionCalls(requestId: string): {
    runQuery: (query: FunctionReference<"query", "public" | "internal"> | FunctionReference_future<"query", "public" | "internal">, args?: Record<string, Value>) => Promise<any>;
    runMutation: (mutation: FunctionReference<"mutation", "public" | "internal"> | FunctionReference_future<"mutation", "public" | "internal">, args?: Record<string, Value>) => Promise<any>;
    runAction: (action: FunctionReference<"action", "public" | "internal"> | FunctionReference_future<"action", "public" | "internal">, args?: Record<string, Value>) => Promise<any>;
};
/**
