...
var import_checkForSlowSchemaValidation = require("./checkForSlowSchemaValidation.js");
...
async function startComponentsPushAndCodegen(ctx, parentSpan, projectConfig, configPath, options) {
  ...
  if (options.dryRun && options.warnOnSlowSchemaValidation) {
    await parentSpan.enterAsync(
      ...
      (span) => (0, import_checkForSlowSchemaValidation.checkForSlowSchemaValidation)({
        ctx,
        span,
        request: startPushRequest,
        options
