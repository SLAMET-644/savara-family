import { FunctionReference, FunctionReference_future, OptionalRestArgs } from "../server/api.js";
...
export interface Scheduler {
     ...
     **/
    runAfter<FuncRef extends SchedulableFunctionReferenceCompat>(delayMs: number, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): Promise<Id<"_scheduled_functions">>;
    /**
     ...
     * system table.
     **/
    runAt<FuncRef extends SchedulableFunctionReferenceCompat>(timestamp: number | Date, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): Promise<Id<"_scheduled_functions">>;
    /**
