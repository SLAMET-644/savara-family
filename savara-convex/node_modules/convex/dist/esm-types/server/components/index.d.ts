import { AnyFunctionReference, FunctionReference, FunctionReference_future, FunctionType } from "../api.js";
 ...
 * This API is unstable and may change in subsequent releases.
 */
export declare function createFunctionHandle<Type extends FunctionType, Args extends DefaultFunctionArgs, ReturnType>(functionReference: FunctionReference<Type, "public" | "internal", Args, ReturnType> | FunctionReference_future<Type, "public" | "internal", Args, ReturnType>): Promise<FunctionHandle<Type, Args, ReturnType>>;
