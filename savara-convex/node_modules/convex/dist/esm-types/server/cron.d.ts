import { FunctionReference_future, OptionalRestArgs } from "../server/api.js";
import { JSONValue } from "../values/index.js";
import { SchedulableFunctionReference } from "./scheduler.js";
type SchedulableFunctionReferenceCompat = SchedulableFunctionReference | FunctionReference_future<"mutation" | "action", "public" | "internal">;
type CronSchedule = {
    type: "cron";
    cron: string;
};
...
export declare class Crons {
     ...
     */
    interval<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, schedule: Interval, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    /**
     ...
     * @param args - The arguments to the function.
     */
    hourly<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    hourly<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, schedule: Hourly, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    /**
     ...
     * @param args - The arguments to the function.
     */
    daily<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, schedule: Daily, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    /**
     ...
     * {@link FunctionReference_future} for the function to schedule.
     */
    weekly<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, schedule: Weekly, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    /**
     ...
     * @param args - The arguments to the function.
     */
    monthly<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, schedule: Monthly, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
    /**
     ...
     * @param args - The arguments to the function.
     */
    cron<FuncRef extends SchedulableFunctionReferenceCompat>(cronIdentifier: string, cron: CronString, functionReference: FuncRef, ...args: OptionalRestArgs<FuncRef>): void;
}
export {};
