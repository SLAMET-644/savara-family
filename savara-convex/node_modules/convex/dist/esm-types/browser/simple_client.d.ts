import { FunctionArgs, FunctionReturnType, PaginationResult, FunctionReference, FunctionReference_future } from "../server/index.js";
...
export declare class ConvexClient {
     ...
     */
    onUpdate<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, args: FunctionArgs<Query>, callback: (result: FunctionReturnType<Query>) => unknown, onError?: (e: Error) => unknown): Unsubscribe<FunctionReturnType<Query>>;
    /**
     ...
     */
    onPaginatedUpdate_experimental<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, args: FunctionArgs<Query>, options: {
     ...
     */
    mutation<Mutation extends FunctionReference<"mutation"> | FunctionReference_future<"mutation">>(mutation: Mutation, args: FunctionArgs<Mutation>, options?: MutationOptions): Promise<Awaited<FunctionReturnType<Mutation>>>;
    /**
     ...
     */
    action<Action extends FunctionReference<"action"> | FunctionReference_future<"action">>(action: Action, args: FunctionArgs<Action>): Promise<Awaited<FunctionReturnType<Action>>>;
    /**
     ...
     */
    query<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, args: FunctionArgs<Query>): Promise<Awaited<FunctionReturnType<Query>>>;
    /**
