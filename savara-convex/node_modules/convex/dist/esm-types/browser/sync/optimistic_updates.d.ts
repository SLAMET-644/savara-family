...
import { FunctionArgs, FunctionReturnType, OptionalRestArgs, FunctionReference, FunctionReference_future } from "../../server/api.js";
/**
...
export interface OptimisticLocalStore {
     ...
     * in the client.
     */
    getQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, ...args: OptionalRestArgs<Query>): undefined | FunctionReturnType<Query>;
    /**
     ...
     */
    getAllQueries<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query): {
     ...
     * it from the client.
     */
    setQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, args: FunctionArgs<Query>, value: undefined | FunctionReturnType<Query>): void;
}
/**
