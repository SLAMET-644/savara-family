...
type RequestForQueriesCompat = Record<Identifier, {
...
export interface CreateWatch {
    (query: FunctionReference<"query"> | FunctionReference_future<"query">, args: Record<string, Value>, options: {
...
export declare class QueriesObserver {
    ...
    setQueries(newQueries: RequestForQueriesCompat): void;
    subscribe(listener: () => void): () => void;
    getLocalResults(queries: RequestForQueriesCompat): Record<Identifier, Value | undefined | Error | PaginatedQueryResult<Value>>;
