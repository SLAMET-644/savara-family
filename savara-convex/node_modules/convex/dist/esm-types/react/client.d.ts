...
import { ArgsAndOptions, FunctionArgs, FunctionReturnType, OptionalRestArgs, FunctionReference, FunctionReference_future } from "../server/api.js";
 ...
 * @public
 */
export interface ReactMutation<Mutation extends FunctionReference<"mutation"> | FunctionReference_future<"mutation">> {
    /**
...
export declare function createMutation(mutationReference: FunctionReference<"mutation"> | FunctionReference_future<"mutation">, client: ConvexReactClient, update?: OptimisticUpdate<any>): ReactMutation<any>;
/**
 * An interface to execute a Convex action on the server.
 *
 * @public
 */
export interface ReactAction<Action extends FunctionReference<"action"> | FunctionReference_future<"action">> {
    /**
...
export declare class ConvexReactClient {
     ...
     */
    watchQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, ...argsAndOptions: ArgsAndOptions<Query, WatchQueryOptions>): Watch<FunctionReturnType<Query>>;
    /**
     ...
     */
    prewarmQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(queryOptions: QueryOptions<Query> & {
     ...
     */
    mutation<Mutation extends FunctionReference<"mutation"> | FunctionReference_future<"mutation">>(mutation: Mutation, ...argsAndOptions: ArgsAndOptions<Mutation, MutationOptions<FunctionArgs<Mutation>>>): Promise<FunctionReturnType<Mutation>>;
    /**
...
export type OptionalRestArgsOrSkip<FuncRef extends FunctionReference<any> | FunctionReference_future<any>> = FunctionArgs<FuncRef> extends EmptyObject ? [args?: EmptyObject | "skip"] : [args: FunctionArgs<FuncRef> | "skip"];
/**
...
type UseQueryOptions<Query extends FunctionReference<"query"> | FunctionReference_future<"query">, ThrowOnError extends boolean> = {
    query: Query;
 ...
 * @public
 */
export declare function useQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, ...args: OptionalRestArgsOrSkip<Query>): FunctionReturnType<Query> | undefined;
/**
 ...
 * @public
 */
export declare function useQuery_experimental<Query extends FunctionReference<"query"> | FunctionReference_future<"query">, ThrowOnError extends boolean = false>(options: UseQueryOptions<Query, ThrowOnError>): UseQueryResult<FunctionReturnType<Query>, ThrowOnError>;
/**
 ...
 * @public
 */
export declare function useMutation<Mutation extends FunctionReference<"mutation"> | FunctionReference_future<"mutation">>(mutation: Mutation): ReactMutation<Mutation>;
/**
 ...
 * @public
 */
export declare function useAction<Action extends FunctionReference<"action"> | FunctionReference_future<"action">>(action: Action): ReactAction<Action>;
/**
