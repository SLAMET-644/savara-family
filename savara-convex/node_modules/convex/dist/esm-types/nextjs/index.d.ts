...
import { ArgsAndOptions, FunctionReturnType, FunctionReference, FunctionReference_future } from "../server/index.js";
/**
 ...
 */
export declare function preloadQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, ...args: ArgsAndOptions<Query, NextjsOptions>): Promise<Preloaded<Query>>;
/**
 ...
 */
export declare function preloadedQueryResult<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(preloaded: Preloaded<Query>): FunctionReturnType<Query>;
/**
 ...
 */
export declare function fetchQuery<Query extends FunctionReference<"query"> | FunctionReference_future<"query">>(query: Query, ...args: ArgsAndOptions<Query, NextjsOptions>): Promise<FunctionReturnType<Query>>;
/**
 ...
 */
export declare function fetchMutation<Mutation extends FunctionReference<"mutation"> | FunctionReference_future<"mutation">>(mutation: Mutation, ...args: ArgsAndOptions<Mutation, NextjsOptions>): Promise<FunctionReturnType<Mutation>>;
/**
 ...
 */
export declare function fetchAction<Action extends FunctionReference<"action"> | FunctionReference_future<"action">>(action: Action, ...args: ArgsAndOptions<Action, NextjsOptions>): Promise<FunctionReturnType<Action>>;
